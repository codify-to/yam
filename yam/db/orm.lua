------------------------------------------------------------------------------
-- Object Relational Mapping to SQLite
...
------------------------------------------------------------------------------
-- Utility function to correctly escape single quotes on string
------------------------------------------------------------------------------
...
local updateAttribute = function( tablename, filter, columnName, columnValue )
  if type(columnValue) == 'string' then
    columnValue = toSqlString( columnValue )
  end
...
local updateAttributes = function( tablename, filter, columns, columnValues )
  ...
  for i,v in ipairs(columns) do
    if type(v) == 'string' then
      newValue = toSqlString( columnValues[i] )
    else
